...
function inject_vanish_button_template() {
	...
	//You can set a lot of things here, texture, shininess etc.  See the aframe docs on materials
	bh.value = "color:purple; metalness:1.0; ";
	newEntity.setAttributeNode(bh);
